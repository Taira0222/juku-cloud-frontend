...
export const useUpdateLessonNoteMutation = (
  options?: UseMutationOptions<lessonNoteType, unknown, LessonNoteUpdateRequest>
) => {
  const queryClient = useQueryClient();

  return useMutation<lessonNoteType, unknown, LessonNoteUpdateRequest>({
    mutationFn: (payload: LessonNoteUpdateRequest) => UpdateLessonNote(payload),
    ...options,
