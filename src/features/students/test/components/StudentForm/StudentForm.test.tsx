...
describe("StudentForm", () => {
  const wrapper = (props: StudentFormProps<"create" | "edit">) => {
    render(<StudentForm {...props} />);
  };

  test("should render correctly for create mode", () => {
    const mockProps: StudentFormProps<"create"> = {
      mode: "create",
  ...
  test("should render correctly for edit mode", () => {
    const mockProps: StudentFormProps<"edit"> = {
      mode: "edit",
      value: editStudentMockPayload,
      onChange: vi.fn(() => {}),
      onSubmit: vi.fn(() => {}),
      loading: false,
      teachers: [mockTeachers[0], mockTeachers[1]], // Teacher1, Teacher2
